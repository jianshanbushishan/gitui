...
pub struct KeysList {
	...
	pub diff_line_start: GituiKeyEvent,
	pub diff_line_end: GituiKeyEvent,
...
impl Default for KeysList {
	fn default() -> Self {
		Self {
			...
			stash_pop: GituiKeyEvent::new(KeyCode::Char('p'),  KeyModifiers::empty()),
			...
			copy_path: GituiKeyEvent::new(KeyCode::Char('Y'),  KeyModifiers::SHIFT),
			...
			branch_view_log: GituiKeyEvent::new(KeyCode::Char('v'), KeyModifiers::empty()),
			...
			diff_line_start: GituiKeyEvent::new(KeyCode::Char('0'),  KeyModifiers::empty()),
			diff_line_end: GituiKeyEvent::new(KeyCode::Char('$'),  KeyModifiers::empty()),
